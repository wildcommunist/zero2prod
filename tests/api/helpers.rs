...
impl TestApp {
        ...
        Body: serde::Serialize,
    {
        self.api_client
            ...
            .send()
            .await
            .expect("Failed to execute send newsletter request.")
    }

    pub async fn with_login(&self) -> reqwest::Response {
        self.api_client
            ...
            .send()
            .await
            .expect("Failed to execute with_login request")
    }
    ...
    pub async fn get_login_html(&self) -> String {
        self.api_client
            ...
            .send()
            .await
            .expect("Failed to get login page html")
            .text()
            .await
            .unwrap()
    }
...
pub async fn spawn_app() -> TestApp {
    ...
    let test_app = TestApp {
        ...
        api_client: client,
        email_client: settings.email_client.client(),
    };
